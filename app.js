...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const UI = {
    en: {
      ...
      send: 'Send Message', sending: 'Sending…', sent: 'Your email client should open. If not, email me directly.',
    ...
    fr: {
      ...
      send: 'Envoyer le message', sending: 'Envoi…', sent: "Votre client email devrait s'ouvrir. Sinon, contactez-moi directement.",
  ...
  $('contact-form').addEventListener('submit', (e) => {
    ...
    setTimeout(() => { btn.disabled = false; btn.textContent = d.send; note.textContent = d.sent; note.className = 'form-note success'; }, 1200);
  });
